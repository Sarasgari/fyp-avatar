	...
	return (
		...
		>
			...
			<Button
				...
				variant="ghost"
				size="icon"
				className="size-9 shrink-0 rounded-full border-white/70 bg-white/58 text-blue-800/62 hover:bg-white/86 hover:text-blue-950"
	...
	return (
		<ThreadPrimitive.ScrollToBottom asChild>
			<TooltipIconButton
				...
				variant="outline"
				className="aui-thread-scroll-to-bottom absolute -top-11 z-10 size-9 self-center rounded-full bg-white/84 p-0 disabled:invisible dark:bg-background dark:hover:bg-accent"
			>
				<ArrowDownIcon />
			</TooltipIconButton>
		...
		>
			<SuggestionPrimitive.Trigger send asChild>
				<Button
					variant="ghost"
					className={cn(
						"aui-thread-welcome-suggestion h-auto w-full flex-wrap items-start justify-start gap-1 rounded-2xl border-white/78 bg-white/72 px-3.5 py-2.5 text-left text-[13px] text-blue-950 hover:bg-white/90 @md:flex-col",
			...
			<AuiIf condition={(s) => !s.thread.isRunning}>
				<ComposerPrimitive.Send asChild>
					<TooltipIconButton
						...
						variant="default"
						size="icon"
						className="aui-composer-send size-9 rounded-full text-white"
			...
			<AuiIf condition={(s) => s.thread.isRunning}>
				<ComposerPrimitive.Cancel asChild>
					<Button
						...
						variant="secondary"
						size="icon"
						className="aui-composer-cancel size-9 rounded-full text-blue-950"
